  ...
  const response = await ai.models.generateContent({
    ...
    contents:  
      "You are a cv text content to object assistant." 
        ...
        +"     {"
        +"       name:''/* name of the experience for example if the experience is a job then put the name of the job if it's a project put the name of the project. The experience globalizes everything that you did into the company. You can put activities into the description and keep the name headline*/,"
        +"       newname:''/*Leave empty*/,"
        +"       company: '',"
        +"       position: '',"
        +"       startDate: '',"
        ...
        +"       description: '',/*Put all tasks and tools used during that experience*/"
        +"       id: '' /*put deg for all experience*/,"
        +"       value:''/*put index of array element as an integer*/"
        +"     },"
        +"   ],"
